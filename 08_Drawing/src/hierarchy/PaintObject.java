...
public abstract class PaintObject implements Serializable {
	...
	/**
	 * Needed this for Serializable Objects that change between writeObject and
	 * readObject. We can also save a list of PaintObjects and send the same list
	 * over the network.
	 */
	...
	// Each subclass must override draw since each shape is drawn differently on a
	// canvas
